...
LL MOD;
inline LL add(LL a, LL b, LL mod=MOD) { return a + b < mod ? a + b : a + b - mod; }
inline void addBy(LL &a, LL b, LL mod=MOD) { a = add(a, b, mod); }
inline LL sub(LL a, LL b, LL mod=MOD) { return a - b < 0 ? a - b + mod : a - b; }
inline void subBy(LL &a, LL b, LL mod=MOD) { a = sub(a, b, mod); }
