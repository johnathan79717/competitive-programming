...
struct SegmentTree {
    ...
    VI v;
    //typedef pair<int, pair<T*, T::iterator>> P;
    //struct Compare {
        ...
        if (t == 1) {
            ...
            if (r - l + 1 < 3) {
                ...
                //while(st.pq.size()) {
                    ...
                    //st.pq.pop();
                    //b.PB(pr.X);
                    //if (SZ(b) >= 3 && b.back() + b[SZ(b)-2] > b[SZ(b)-3]) {
                        //ans = 0ll + b.back() + b[SZ(b)-2] + b[SZ(b) - 3];
                        //break;
                    //}
                    //auto &p2 = pr.Y;
                    //T* d = p2.X;
                    ...
                    //it++;
                    //if (it != d->end()) {
                        //st.pq.emplace(*it, MP(d, it));
                    //}
                //}
                //st.pq = decltype(st.pq)();
                //PL(ans);
            }
        }
    }
