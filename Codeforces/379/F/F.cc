...
int parent[MAX_N+1][22], depth[MAX_N+1];
...
int main() {
  ...
  REP(qq, q) {
    ...
    if(distance(n, v2) > diameter)
      v1 = n;
    else if(distance(n, v1) > diameter)
      v2 = n;
    PI(diameter = distance(v1, v2));
  }
  return 0;
}
